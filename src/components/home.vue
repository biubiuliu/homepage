<template>
  <div class="hello">
    <header>
      ...
      <form id="searchBar" action="" class="searchBar">
        <ul id="searchEnginLogo" class="searchEnginLogo">
          <li class="active">
            <img src="../assets/google.svg" alt="google" @click="switchSearchEngin">
          </li>
          <li>
            <img src="../assets/baidu.svg" alt="baidu" @click="switchSearchEngin">
          </li>
        </ul>
        <input id="inputBar" type="text" placeholder="点击左边图标切换搜索引擎">
    ...
    <div id="main">
      ...
      <bar-card :edit-btn="editBtnData" :card-data="cardData" @handCardRouter="handCardRouter" />
    </div>
  </div>
</template>
...
export default {
    ...
    return {
      ...
      cardData: [
        ...
        },
        {
          ...
          content:
            '用户可以自定义下载多种格式的icon，平台也可将图标转换为字体，便于前端工程师自由调整与调用。'
        },
        {
          title: 'Font Awesome',
          subhead: 'Awesome 字体库',
        ...
        },
        {
          ...
          content:
            'php程序员工具箱是迄今为止全网wei一一款php程序员的专属工具箱，集合了php环境搭建、在线小工具、原生手册、文字与视频教程、问答社区等。'
        },
        {
          title: 'carbon',
          subhead: 'carbon',
          ...
          content:
            '创建并共享源代码的精美图片,开始输入或将文件放入文本区域以开始使用。'
        },
        {
          title: '私人影院',
          subhead: 'move',
        ...
        },
        {
          ...
          content:
            '斗鱼- 每个人的直播平台提供高清、快捷、流畅的视频直播和游戏赛事直播服务,包含英雄联盟lol直播、穿越火线cf直播、dota2直播、美女直播等各类热门游戏赛事直播和各种...'
        },
        {
          title: '面试题',
          subhead: '面试题',
  ...
  methods: {
    ...
    //     this.editBtnData.transform =
    //       'rotate(' + this.getNum(this.rotateArr) + 'deg)'
    //   }, 20)
    // },
    successBtn() {
    ...
    listenToUser() {
      ...
      inputBar.addEventListener('focusout', function(e) {
        this.ifInputting = false
        const searchEnginLogo = document.getElementById('searchEnginLogo')
        const engin = searchEnginLogo.getAttribute('data-engin')
      ...
      searchBtn.onclick = function(e) {
        e.preventDefault()
        const searchContent = inputBar.value
        // 判断是什么搜索引擎
        const searchEnginLogo = document.getElementById('searchEnginLogo')
        const engin = searchEnginLogo.getAttribute('data-engin')
        ...
        switch (engin) {
          case 'baidu':
            window.open(
              'https://www.baidu.com/s?wd=' + searchContent,
              '_blank'
            )
            break
          case 'google':
    ...
    switchSearchEngin() {
      ...
      const googleLogo = document.querySelector(
        '#searchEnginLogo li:nth-child(1)'
      )
      const baiduLogo = document.querySelector(
        '#searchEnginLogo li:nth-child(2)'
      )
      const googlePic = document.querySelector('#searchEnginPic li:nth-child(1)')
      const baiduPic = document.querySelector('#searchEnginPic li:nth-child(2)')
      const inputBar = document.getElementById('inputBar')
